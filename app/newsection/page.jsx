   ...
   return data &&  setTech(...data) 
    ...
    const getSeletedTechnology = async(value) => {
        ...
        if(find >= 0) 
            ...
            //  projects(arrayOfTech, [])
         
        else 
             await  arrayOfTech.push(value)
           
             const {data} =  await allProject(arrayOfTech,arrayOfCategory)
    ...
    const getSeletedCategory = async(value) => {
        ...
        if(find >= 0)
             await arrayOfCategory.splice(find,1 )
          
            // projects([],arrayOfCategory )
        
        else  
   await arrayOfCategory.push(value)
