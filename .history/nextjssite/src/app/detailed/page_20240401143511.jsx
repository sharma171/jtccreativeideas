                        ...
                        <div className="col-md-7 lhs">
                            <div className="carousel-product">
                                <div className="slide1">
                                    <Image src={SlideImg1} alt="slideImages"></Image>
                                </div>
                                <div className="slide2">
                                    <Image src={SlideImg2} alt="slideImages"></Image>
                                </div>
                                <div className="slide3">
                                    <Image src={SlideImg3} alt="slideImages"></Image>
                                </div>
                                <div className="slide4">
                                    <Image src={SlideImg4} alt="slideImages"></Image>
                                </div>
                            </div>
                        </div>
