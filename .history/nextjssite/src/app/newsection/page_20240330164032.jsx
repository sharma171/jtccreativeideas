    ...
    return(
        ...
        <section className="project-category">
            <div className="container">
                ...
                <div class="row">
                    <div class="col-md-3 ecom-filter">
                        ...
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M6.5 10H13.5" stroke="#121212" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M10 13.6L10 6.59998" stroke="#121212" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        </div>
                    ...
                    <div class="col-md-9 ecom-content"></div>
                </div>
            </div>
        </section>
        </>
